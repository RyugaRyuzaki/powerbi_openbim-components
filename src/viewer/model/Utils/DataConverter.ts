...
import { IfcCategories, IfcItemsCategories } from "./IfcCategories";
...
export class DataConverter {
  ...
  private setupModel() {
    ...
    this._model.items.forEach( ( item: FRAGS.Fragment ) => {
      this.setupFragment( item )
    } )
  }
  private setupFragment = ( fragment: FRAGS.Fragment ) => {
